            ...
            <ul className="mt-3">
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname === "/Dashboard" && "border-2 border-blue-500"
                }`}
              >
                <NavLink
                  end
                  to="/Dashboard"
                  className={`block text-slate-900 hover:text-blue-500 truncate transition duration-150 ${
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname === "/" && "border-2 border-blue-500"
                }`}
              >
                <NavLink
                  end
